...
Downstream consumers have full control over model selection and generation hyperparameters on every request. All 14 pipeline agents respect these parameters.
