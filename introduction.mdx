...
Flash receives user queries via timepointai.com and produces grounded scenes. It draws on Clockchain (causal graph), Pro (SNAG engine), and SNAG-Bench (benchmark). Clockchain and Pro share TDF (data format) as their interchange layer.
