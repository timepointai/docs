...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/timepointai/timepoint-pro">
    `timepointai/timepoint-pro` — Apache-2.0, Python, FastAPI + LangGraph
  </Card>
  <Card title="Detailed Docs" icon="book" href="https://www.mintlify.com/timepointai/timepoint-pro">
