...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/timepoint-ai/timepoint-tdf">
    `timepoint-ai/timepoint-tdf` — Apache-2.0, Pure Python, Pydantic
  </Card>
  <Card title="Detailed Docs" icon="book" href="https://www.mintlify.com/timepoint-ai/timepoint-tdf">
